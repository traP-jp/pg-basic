...
func main() {
    ...
    fmt.Scan >> trap_id1 >> student_id1 >> grade1
...
<<<@/go-text/chapter-6/struct-raw.go{go:line-numbers}

少し見やすくなったように感じないだろうか？

<<<@/go-text/chapter-6/struct.go#define{go:line-numbers}
...
<<<@/go-text/chapter-6/struct.go#use{go:line-numbers}
