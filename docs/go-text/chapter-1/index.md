...
::: tip
プログラミング"言語"というものは様々あって、「Go」はその中の一つである。他にも「Python」「JavaScript」「C#」など言語がある中で今回Goを選んでいる理由は２つ。

1. 大抵の言語はGoの（もっと言えばCの）派生だから。Goで一通りプログラミングを勉強してしまえば、C#など他の言語にすぐに乗り換えられます。
2. Goが比較的コンピュータ寄りだから。
